    ...
    <b-container fluid="xs" class="tile_count">
      <b-row class="tile_stats_count">
        ...
        <b-col sm="3" align-v="center">
            ...
            <b-col class="count green--text"><countTo class="count" :startVal="startVal" :endVal="endVal[2]" separator="." :duration="3000"></countTo></b-col>                  
        </b-col>
        <b-col sm="3" style="text-align: center;">
            <span class="count_top">Total</span>
            <b-col class="count green--text"><countTo class="count" :startVal="startVal" :endVal="endVal[3]" separator="." :duration="3000"></countTo></b-col>                  
        </b-col>
      </b-row>
    </b-container>
...
export default {
  ...
  data () {
    return {
        ...
        items: [],
        	excelHead :{ 
                "Centro" :  "gls_centroresidencial",  
                "Tipo" :  "descripcion", 
                "Rit" : "rit" ,
                "Fec. Resolucion" :  "fecha_resolucion",
                "80 Bis" :  "flg_80bis" ,
                "T Egreso" : "dia" ,
                "F. Nacimiento" : "fec_nacimiento" ,
                "Edad" : "edad" ,
                "Curador"  : "flg_curador" 
              },
        data : [],
  ...
  methods: {
          ...
          if(this.filter === null) {
			...
			/// Filtro el array 
              ...
              || ((m.fecha_resolucion.match(this.filter)) && 
                 ...
                 (this.filterOn[0] == undefined && this.filterOn[1] ==  undefined && this.filterOn[2] == undefined)))         
              || ((m.flg_80bis == this.filter) && (this.filterOn[0] == undefined && this.filterOn[1] ==  undefined && this.filterOn[2] == undefined))
    ...
    requestData: function (dateRange) {
      ...
      const req1 = url + '/familia/centrosEgresos'
      const req2 = url + '/familia/centrosEgresosDetalles'
      ...
      axios.all([
        ...
        Object.values(data2.recordset).map((type) => {
            this.items.push({isActive: true, gls_centroresidencial: type.gls_centroresidencial, descripcion: type.descripcion, 
                             rit: type.rit, fecha_resolucion: type.fecha_resolucion, flg_80bis: type.flg_80bis, 
                             dia: type.dia.toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.'), fec_nacimiento: type.fec_nacimiento, edad: type.edad, flg_curador: type.flg_curador,
                             _rowVariant: (type.edad > 17 && type.edad < 120) ? 'danger': ''  });
            this.data.push({gls_centroresidencial: type.gls_centroresidencial, descripcion: type.descripcion, rit: type.rit, fecha_resolucion: type.fecha_resolucion, flg_80bis: type.flg_80bis, fec_nacimiento: type.fec_nacimiento, edad: type.edad, flg_curador: type.flg_curador });
        })
