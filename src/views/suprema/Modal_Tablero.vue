                                            ...
                                            <template v-slot:[`body`]="{ items }">
                                                <tbody>
                                                    <tr v-for="(item, index) in items " :key="item.crr_idfuncionario">
                                                        ...
                                                        <td style ="width:25%; text-align: center" v-if="index <= 4">{{ item.resoluciones }}</td>
                        ...
                        <v-col md="5">
                            <v-row>
                                <v-col>
                                    ...
                                    <hr />
                                    <v-row>
                                        <v-col md="4" class="text-center mt-1">
                            ...
                            <v-card class="primary">
                                <v-card-text>
                                    <v-row align="center">
                                        <v-col md="3" class="text-center white--text mt-0 px-2">
                                            <h5>
                                                No <br />
                                                Realizadas
                                            </h5>
                                        ...
                                        <v-col md="3" class="text-center white--text px-2">
                                            Reprogramadas <br />
                                            <h5>
                        ...
                        <v-col md="4">
                            <v-card class="mr-3">
                                ...
                                <v-dialog v-model="dialogAtrasos" max-width="1000">
                                    <v-card>
                                        <v-card-title class="primary white--text">
                                            Horario de Inicio de Audiencias
                                            <v-spacer></v-spacer>
                                                ...
                                                <template v-slot:[`body`]="{ items }">
                                                    <tbody>
                                                        <tr v-for="item in items " :key="item.crr_idfuncionario">
                                                            ...
                                                            <td style ="text-align: center">{{ item.resoluciones }}</td>
...
export default {
    ...
    methods: { 
        ...
        consulta_ing_ter_res() {
           // console.log(this.fechasTablero);
            ...
            axios.all([
                ...
                axios.get(req1, {
                    params: {
                            cod_corte: this.fechasTablero.cod_corte,
                            cod_tribunal: this.fechasTablero.cod_tribunal,
                            anoInicio: this.fechasTablero.ano -1,
                            mesInicio: this.fechasTablero.mes,
                            anoFin: this.fechasTablero.ano,
                            mesFin: this.fechasTablero.mes
                    }
                }),
