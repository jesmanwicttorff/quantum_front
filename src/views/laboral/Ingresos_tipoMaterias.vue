<template>
    <v-card>
        ...
        <v-card-text>
            <v-row>
                <v-col sm="12">
                    <ModalDetalleIngresosMateria class="d-inline-flex ml-2"/> 
                </v-col>
            </v-row>
                    ...
                    <v-data-table 
                        ...
                        <template v-slot:[`body`]="{ items }">
                            ...
                            <tr v-for="item in items " :key="item.increment">
                                ...
                                <td style ="text-align: center">{{ item.gls_materia }}</td>
...
import ModalDetalleIngresosMateria from '../../views/laboral/ModalDetallesIngresosMateria'
...
export default {
    ...
    methods: { 
        ...
        consulta_ingreso() {
            ...
            const req1 = url + '/laboral/ingresos_materia' 
            this.Query_Ingreso = []
            this.total = 0
            ...
            axios.all([
                    ...
                    Object.values(data1.recordset).map((type) => {
                        ...
                        objIngreso.gls_materia = type.gls_materia
                        objIngreso.cantidad = type.cantidad
                        this.total= this.total + type.cantidad

                        dataTable.push({ name: type.gls_materia, y: type.cantidad})
