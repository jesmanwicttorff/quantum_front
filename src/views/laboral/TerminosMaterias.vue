...
export default {
    ...
    methods: { 
        ...
        consulta_ingreso() {
            ...
            const req1 = url + '/laboral/terminos_materias' 
            this.Query_Ingreso = []
            this.total = 0
            ...
            axios.all([
                    ...
                    Object.values(data1.recordset).map((type) => {
                        ...
                        objTermino.gls_materia = type.gls_materia
