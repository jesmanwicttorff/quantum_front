...
export default {
        ...
        data: () => ({
            ...
            ,headers: [
                ...
                {text: 'RIT', align: 'center', value: 'rit', class : 'primary white--text', width: '19%'},
                {text: 'RUC', align: 'center', value: 'ruc', class : 'primary white--text', width: '19%'},
                {text: 'Tipo Causa', align: 'center', value: 'gls_tipo_causa', class : 'primary white--text', width: '19%'},
                {text: 'Fecha de ingreso', align: 'center', value: 'fec_ingreso', class : 'primary white--text', width: '19%'},
                {text: 'Tipo ingreso', align: 'center', value: 'gls_ing_causa', class : 'primary white--text', width: '19%'}
            ]
            ,user: [{
        ...
        methods:{
            ...
            requestData: function(){
                ...
                this.setModal(true) // Para cargar la ventana Modal
                 ...
                 console.log(this.setModal(true));
                axios.all([
                    axios.get(req1, {
                        params: {
