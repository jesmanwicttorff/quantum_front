                    ...
                    <v-data-table 
                        ...
                        <template v-slot:[`body`]="{ items }">
                            ...
                            <tr v-for="item in items " :key="item.increment">
                                ...
                                <td style ="text-align: center">{{ item.tip_causa }}</td>
...
import ModalDetalleIngresos from '../../views/laboral/ModalDetallesIngresosCausas'
...
export default {
    ...
    data () {
        return {
            ...
            headers: [
                ...
                { text: 'Tipo Causa',  align: 'center', value: 'tip_causa', class : 'primary white--text', width: '60%' },
    ...
    methods: { 
        ...
        consulta_ingreso() {
            ...
            const req1 = url + '/laboral/ingresos_causa' 
            this.Query_Ingreso = []
            this.total = 0
            ...
            axios.all([
                    ...
                    Object.values(data1.recordset).map((type) => {
                        ...
                        dataTable.push({ name: type.tip_causa, y: type.cantidad}) // Push para la grafica
