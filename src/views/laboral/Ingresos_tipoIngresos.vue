                    ...
                    <v-data-table 
                        ...
                        <template v-slot:[`body`]="{ items }">
                            ...
                            <tr v-for="item in items " :key="item.increment">
                                ...
                                <td style ="text-align: center">{{ item.gls_ing_causa }}</td>
...
import ModalDetalleIngresosTipos from '../../views/laboral/ModalDetallesIngresosTipos'
...
export default {
    ...
    data () {
        return {
            ...
            headers: [
                ...
                { text: 'Tipo Ingreso',  align: 'center', value: 'gls_ing_causa', class : 'primary white--text', width: '60%' },
    ...
    methods: { 
        ...
        consulta_ingreso() {
            ...
            const req1 = url + '/laboral/ingresos_tipo_ingreso' 
            this.Query_Ingreso = []
            this.total = 0
            ...
            axios.all([
                    ...
                    Object.values(data1.recordset).map((type) => {
                        ...
                        objIngreso.gls_ing_causa = type.gls_ing_causa
                        objIngreso.cantidad = type.cantidad
                        this.total = this.total + type.cantidad

                        dataTable.push({ name: type.gls_ing_causa, y: type.cantidad})
                        this.Query_Ingreso.push(objIngreso)
                        increment ++ 
                    })
