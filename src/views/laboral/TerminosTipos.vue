                    ...
                    <v-data-table 
                        ...
                        <template v-slot:[`body`]="{ items }">
                            ...
                            <tr v-for="item in items " :key="item.increment">
                                ...
                                <td style ="text-align: center">{{ item.gls_tipfallada }}</td>
    ...
    data () {
        return {
            ...
            headers: [
                ...
                { text: 'Tipo Término',  align: 'center', value: 'gls_tipfallada', class : 'primary white--text', width: '60%' },
        ...
        consulta_ingreso() {
            ...
            axios.all([
                    ...
                    Object.values(data1.recordset).map((type) => {
                        ...
                        dataTable.push({ name: type.gls_tipfallada, y: type.cantidad})
