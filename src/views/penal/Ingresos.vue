                        ...
                        <tbody>
                            ...
                            <tr v-for="(item, index) in tbody"  :key="index">                                   
                                ...
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 1, exhorto: user.exhorto, tipo: user.tipo } }"> {{item.enero}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 2, exhorto: user.exhorto, tipo: user.tipo } }"> {{item.febrero}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 3 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.marzo}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 4 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.abril}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 5 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.mayo}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 6 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.junio}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 7 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.julio}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 8 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.agosto}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 9 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.septiembre}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 10 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.octubre}}  </router-link> 
                                </td>
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 11 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.noviembre}}  </router-link> 
                                </td> 
                                <td class="text-center">
                                    <router-link style="text-decoration: none;" :to="{ name: 'PenalIngresosDetalles', params: { ano: item.ano, mes: 12 , exhorto: user.exhorto, tipo: user.tipo } }"> {{item.diciembre}}  </router-link> 
                                </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
                            </tr>
                        </tbody>
                        <tfoot>
...
export default {
    ...
    methods:{
        ...
        sentRequest(){
            ...
            const req1 = url + '/penal/resumenes'
            let rango
            if(this.user.rango==null){
                rango = 0
            }else{
            ...
            axios.all([
                    ...
                    this.chartOptions.title.text =  'Ingresos' // Titulo del grafico de lineas
